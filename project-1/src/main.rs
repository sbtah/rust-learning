...
fn main() {
    ...
    println!("My fav season is: {season}");
    println!("Team scored: {}, while touchdown points are: {}", points_scored, TOUCHDOWN_POINTS);
    println!("Event starts at: {0}", event_time);

    #[allow(unused_variables)]
    let favorite_beverage = String::from("Water");
}
